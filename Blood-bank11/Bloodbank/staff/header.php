        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><span>Health Advicer</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			 ...
			 <li><a href="add_healthTip.php"><i class="fa fa-eye"></i>Add Health Tips  </a></li>
			  <li><a href="viewhealthTip.php"><i class="fa fa-eye"></i>List Health Tips </a></li> 	
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                   <!-- <img src="images/img.jpg" alt="">-->Health Advicer
